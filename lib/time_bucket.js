...
TimeBucket.prototype.totals = function () {
        ...
        //We make a copy here because if purgeBuckets is called before the
        // totals are stringified, the object won't be consistent.
        var valsCopy = {};
        var keys = Object.keys(self.vals);
        for (var i = 0; i < keys.length; ++i) {
                valsCopy[keys[i]] = self.vals[keys[i]];
        }
        var ret = {
                'count': self.count,
                'values': valsCopy
